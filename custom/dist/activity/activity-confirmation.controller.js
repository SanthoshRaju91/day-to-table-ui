...
(function () {
  ...
  ActivityConfirmationController.$inject = ["RestService", "$location", "$state", "$stateParams", "$log"];
  angular.module('app.activity', []).controller('ActivityConfirmationController', ActivityConfirmationController);
