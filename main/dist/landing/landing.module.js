...
(function () {
    ...
    LandingController.$inject = ["$log", "RestService"];
    angular.module('app.landing', []).config(config).controller('LandingController', LandingController);
    ...
    function LandingController($log, RestService) {
         ...
         */
        RestService.get('/getPopularCourses').then(function (response) {
         ...
         */
        RestService.get('/getUpcomingActivites').then(function (response) {
