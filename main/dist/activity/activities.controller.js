...
(function () {
    ...
    ActivitiesController.$inject = ["$log", "RestService"];
    angular.module('app.activity', []).controller('ActivitiesController', ActivitiesController);
    ...
    function ActivitiesController($log, RestService) {
        ...
        function getActivities(page, sort, filter) {
            ...
            RestService.get('getAllActivitiesForUser', payload).then(function (response) {
